...
#    NAME: Blake Cole                                        #
#    ORGN: MIT                                               #
#    FILE: fwd_kinematic_nn_biased.py                        #
#    DATE: 27 NOV 2020                                       #
# ********************************************************** #
...
LOAD_PATH = './fwd_kinematic_nn_biased.pth'
SAVE_PATH = './fwd_kinematic_nn_biased.pth'
...
# arm length offsets (20-30% error)
dl1 = 0.3
dl2 = -0.2
...
# angle offsets (0.2 rad == 11.5 degree bias)
dq1 = 0.2
dq2 = -0.2
...
print('\n')
print('N/N-2 Input (q) Dimensions  : ', q.shape)
print('N/N-2 Output (x) Dimensions   : ', x.shape)
...
print('\n')
print('N/N-2 Input (q) Size: ', qt.size())
print('N/N-2 Output (x) Size: ', xt.size(), '\n')
...
if (yesno('Train neural net')):
    ...
    plt.title('N/N-2 Neural Net Training on True (Biased) Data')
    plt.axis('tight')
    plt.legend()
    plt.show()
